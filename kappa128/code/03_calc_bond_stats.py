...
# --- Configuration ---
data_folders = sys.argv[1:] if len(sys.argv) > 1 else ["/home/love/apfs/root/kappa128/bondangle"]
    ...
    for tau in target_taus:
        for act in activities:
            ...
            for folder in data_folders:
                pat = os.path.join(folder, f"64_128_{act}_0.1_0.1_{tau_str}_*.bondangle")
